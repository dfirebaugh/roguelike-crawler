...
class CanvasGrid extends Component {
  loadImgs = () => {
    const playerImg = document.getElementById("key:key:player");
    const enemyImg = document.getElementById("key:key:enemy");
    const wallImg = document.getElementById("key:key:wall");
    const floorImg = document.getElementById("key:key:floor");
    const weaponImg = document.getElementById("key:key:weapon");
    const portalImg = document.getElementById("key:key:portal");
    const healthImg = document.getElementById("key:key:health");
    const dungeonMapImg = document.getElementById("key:key:dungeonMap");
    const bossImg = document.getElementById("key:key:boss");
    const hiddenImg = document.getElementById("key:key:hidden");
