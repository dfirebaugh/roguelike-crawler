...
const Cell = props => {
    ...
    let graphics = [
      {
        ...
        show: (
          <img
            alt="wall"
            id={`${props.row}:${props.col}:${props.type}`}
            src={wall}
          />
      ...
      },
      {
        ...
        show: (
          <img
            ...
            src={enemy}
          />
        ) //(props.health <= 0 ? <div className='enemy'></div> : <div className='enemy'></div>)
      },
      {
        type: "boss",
        show: (
  ...
  return (
    <div onClick={handleClick} style={cellStyle}>
      {props.hidden ? getGraphic("hidden") : getGraphic(props.type)}
    </div>
  );
};
